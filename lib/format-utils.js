...
const { NoFormatsError } = require("./errors");
...
exports.chooseFormat = (formats, options) => {
  if (typeof options.format === "object") {
    if (!options.format.url) {
      throw new NoFormatsError("Invalid format given, did you use `ytdl.getInfo()`?");
    }
  ...
  if (!format) {
    throw new NoFormatsError(`No such format found: ${quality}`);
  }
  return format;
};
